...
{#if state.submissions.selectedCount > 0}
  <div
  ...
  >
    ...
    >
      <div class="flex items-center gap-2">
        ...
        >
          <span class="text-sm font-bold"
            >{state.submissions.selectedCount}</span
          >
        </div>
      ...
      <Button
        ...
        onclick={() => state.submissions.showComparison()}
      >
      ...
      <Button
        ...
        size="sm"
        class="text-white hover:bg-white/20 h-8 text-xs"
        onclick={() => state.submissions.openBulkMoveDialog()}
      >
      ...
      <Button
        ...
        size="sm"
        class="text-white hover:bg-white/20 h-8 text-xs"
        onclick={() => state.submissions.bulkArchive()}
      >
      ...
      <button
        ...
        onclick={() => state.submissions.clearSelection()}
      >
        <X class="w-4 h-4" />
      </button>
    </div>
